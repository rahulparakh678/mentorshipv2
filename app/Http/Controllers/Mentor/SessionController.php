    ...
    public function index()
{
    ...
    //     $sessiondatetime = Carbon::createFromFormat('Y-m-d\TH:i', $request->sessiondatetime)->format('Y-m-d H:i:s');


    //     // Check the format of the incoming sessiondatetime
    //     // $sessiondatetime = $request->sessiondatetime;
    
    //     // Try to parse the datetime from the request, if it matches the format
    //     // try {
    //     //     $sessiondatetime = Carbon::createFromFormat('Y-m-d\TH:i', $sessiondatetime)->format('Y-m-d H:i:s');
    //     // } catch (\Carbon\Exceptions\InvalidFormatException $e) {
    //     //     // Log or handle the exception
    //     //     dd('Invalid datetime format: ' . $sessiondatetime);
    //     // }    
    ...
    //     $sessions = Session::whereIn('mentorname_id', $mentorIds)->get();
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'sessiondatetime' => 'required|date_format:Y-m-d H:i:s',  // Validate specific date format
            'sessionlink' => 'required|string',
            'session_title' => 'required|string',
            'session_duration_minutes' => 'required|integer',
            'modulename_id' => 'required|integer',
        ...
        $mentornames = DB::table('mentors')->whereIn('id', $mentorIds)->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        $menteenames = DB::table('mentees')->whereIn('id', $menteeIds)->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
