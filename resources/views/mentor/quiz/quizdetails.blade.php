    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @foreach($moduleCounts as $moduleCount) <!-- Iterate over moduleCounts -->
                        <tr>
                            <td>{{ $moduleCount['module_name'] }}</td>
                            <td>{{ $moduleCount['completed'] }}</td>
                            <td>{{ $moduleCount['pending'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
...
<script>
    const overallCompletedQuizzes = @json($overallCompletedQuizzes);
    const overallPendingQuizzes = @json($overallPendingQuizzes);
